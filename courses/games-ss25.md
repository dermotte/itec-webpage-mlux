...
[2024 web page](?id=courses/games-ss24.md). The lecture is given in German,
...
11. Video Game History ~ [slides](https://docs.google.com/presentation/d/1IHQGHOWF10BfIBZ4X_M6hL9WOrc9lgoP9ACt3R-ifX8/edit?usp=sharing)
...
Submit your Pong clone on Moodle as a .love file on Moodle **April 6th, 2025, midnight**.
...
Submit your game, the zipped project folder, on Moodle until **May 4th, 2025, midnight**.
...
1. Present the project in the lecture on June 23rd, 2025 (4 minutes presentation, 2 minutes Q&A)
    1. list the group members
    1. explain the concept
    1. show the game
    1. talk about the lessons learned (post mortem)

The project can be a stand-alone game, a level for a game, or a mod for a game. If you attended a game jam, please present your game jam project and just create the documents and slides.
