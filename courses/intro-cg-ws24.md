...
7. Textures ~ [slides](https://docs.google.com/presentation/d/1FPGElTPDpqd6O5bhDb12vKEs0lX6jnLukmdZ-2nyfG0/edit?usp=sharing)
7. Raytracing and Real Time Rendering ~ [slides](https://docs.google.com/presentation/d/1nxXdQUDcHllpCyQN-K4LF5ZACRl_biBVeZwHSu3RDlE/edit?usp=sharing)
8. Blender Workshop ~ [slides](https://docs.google.com/presentation/d/1iGWl2tcVnSU5P6Ld8kUuUG3oQu4uSU4YL67gyAHxhP0/edit?usp=sharing) - [video](https://www.youtube.com/watch?v=uQgj7tk8tVE)
...
| EX 07 | Textured Die      | [#29](https://docs.google.com/presentation/d/1FPGElTPDpqd6O5bhDb12vKEs0lX6jnLukmdZ-2nyfG0/edit?usp=sharing) | Dec. 08  |


## Final Project
Please prepare your final project until **January 19, 2025**. Goal of the final project is to apply what you learned in the lecture in a practical way. Basic idea is to model a scene in Blender and render it. 

For the presentation (max duration 3 minutes) on January 20 or January 27, 2025, make sure you can

1. show your result,
2. outline your work (contribution), and
3. discuss the lessons learned and obstacles encountered.

Please also make sure to deliver the following items in a ZIP file via upload on Moodle until **January 19, 2025**
