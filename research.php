<!--- ------------------- MAIN ------------------- -->
<blockquote>
    <p>Yes. In 1917, when Albert Einstein established the theoretic foundation for the laser in his paper "Zur
...
<h2>User Intentions</h2>
<div class="row">
    <div class="col-md-8">
        <p class="text-justify">
            User intentions in multimedia is a novel and promising field. It deals with the motivation <i>why</i> images
            and
            videos are taken, viewed and searched for. Research on user intentions includes qualitative and quantitative
            studies on (i) motivations for search and production of multimedia content, (ii) goals that users want to
            achieve by
            creating and searching multimedia content, and (iii) log and data analysis to find traces of intentions in
            search
            and
            production. A list of selected publications would be:
        </p>
        <ul>
            ...
            <li> M. Lux, C. Kofler, O. Marques (2010) A classification scheme for user intentions in image search. CHI
                2010
                <a href="http://dl.acm.org/citation.cfm?id=1753846.1754078&amp;coll=DL&amp;dl=GUIDE&amp;CFID=55695921&amp;CFTOKEN=54470683"
                   class="urlextern"
            ...
            <li> M. Lux , J. Huber (2012) Why did you record this video? An Exploratory Study on User Intentions for
                Video Production. WIAMIS 2012 <a href="http://dx.doi.org/10.1109/WIAMIS.2012.6226758" class="urlextern"
                                                 title="http://dx.doi.org/10.1109/WIAMIS.2012.6226758"
                                                 rel="nofollow">IEEE</a>
                <a href="http://www.itec.uni-klu.ac.at/~mlux/files/papers/mlux-wiamis-2012-preprint.pdf"
                   ...
                   rel="nofollow">preprint</a>, <a
                    ...
                    title="http://www.slideshare.net/dermotte/why-did-you-record-this-video"
            ...
            <li> C. Lagger, M. Lux, O. Marques, (2012) What Makes People Watch Online Videos: An Exploratory Study.
                Short article teaser published in ACM CIE <a
                    href="http://cie.acm.org/articles/adaptive-video-retrieval-system-based-recent-studies-user-intentions-while-watching-videos-online/"
                    class="urlextern"
                    title="http://cie.acm.org/articles/adaptive-video-retrieval-system-based-recent-studies-user-intentions-while-watching-videos-online/"
                    rel="nofollow">online</a>.
            </li>
            <li> C. Lagger, M. Lux, O. Marques, (2012) What Makes People Watch Online Videos: An Exploratory Study.
                accepted for publication in ACM CIE <a
                    href="http://www.itec.uni-klu.ac.at/~mlux/files/papers/CiE_lagger_lux_preprint.pdf"
                    class="urlextern"
                    title="http://www.itec.uni-klu.ac.at/~mlux/files/papers/CiE_lagger_lux_preprint.pdf"
                    rel="nofollow">preprint</a></li>
            <li> M. Lux, M. Taschwer, O. Marques (2012) A Closer Look at Photographers' Intentions: a Test Dataset, in
                ...
                ACM Multimedia 2012, Oct 29 - Nov 2 2012, Nara, Japan <a
                    ...
                    title="http://www.itec.uni-klu.ac.at/~mlux/files/acmmm2012/cmm4061-lux.pdf"
                    rel="nofollow">preprint</a>,
                <a href="http://www.itec.uni-klu.ac.at/~mlux/files/acmmm2012/CrowdMM-Poster%20B0.pdf" class="urlextern"
                   title="http://www.itec.uni-klu.ac.at/~mlux/files/acmmm2012/CrowdMM-Poster%20B0.pdf"
            ...
            <li> M. Riegler, M. Lux, C. Kofler (2013) Frame the Crowd: Global Visual Features Labeling boosted with
                ...
                Spain, <a href="http://ceur-ws.org/Vol-1043/mediaeval2013_submission_56.pdf" class="urlextern"
                          title="http://ceur-ws.org/Vol-1043/mediaeval2013_submission_56.pdf" rel="nofollow">PDF</a>
            </li>
            <li> M. Lux, D. Xhura, A. Kopper (2014) User Intentions in Digital Photo Production: A Test Data Set.
                MultiMedia Modeling. Springer International Publishing, 2014. <a
                    href="http://link.springer.com/chapter/10.1007/978-3-319-04114-8_15" class="urlextern"
                    title="http://link.springer.com/chapter/10.1007/978-3-319-04114-8_15" rel="nofollow">online</a>
            </li>
        </ul>

        <p>
            We further released a test data set of 1,309 images along with the intentions of the photographers acquired
            in a large survey. More information and the actual data is available here: <a
                href="?id=photointentionsdata">photointentionsdata</a>
        </p>
    </div>
    <div class="col-md-4">
        <p class="text-center">
        <blockquote><h3>Definition of context</h3>
            Context is any information that can be used to characterize the situation of an entity. An entity is
            a person, place, or object that is considered relevant to the interaction between a user and an application,
        ...
        <blockquote>
            <h3>Definition of intention</h3>
            <i>noun</i><br/>
            (1) thing intended; an aim or plan<br/>
            (2) Medicine the healing process of a wound<br/>
            (3) (intentions) Logic conceptions formed by directing the mind towards an object<br/>
...
<div class="col-md-8">
    <p class="text-justify">
        LIRE (Lucene Image Retrieval) is an open source library for content based image retrieval. Besides providing
        multiple common and state of the art retrieval mechanisms it allows for easy use on multiple platforms. LIRE is
        actively used for research, teaching and commercial applications. Due to its modular nature it can be used on
        process level (e.g.
        index images and search) as well as on image feature level. Developers and researchers can easily extend and
        modify
        LIRe to adapt it to their needs. In 2013 Oge Marques and me published a book on LIRE meant to give an
        introduction
        to content based image retrieval as well. Look out for the book at <a
            href="http://www.morganclaypool.com/doi/abs/10.2200/S00468ED1V01Y201301ICR025">Morgan &amp; Claypool</a> or
        at <a
    ...
    <p class="text-justify">In addition to the LIRE Java library there's also a plug-in for Solr, the Apache
        search server based on Lucene. The most impressive use of the LIRE Solr plugin is over at the United Nations for
        their global brand data base. A peer reviewed demo paper explaining the context and approach can be found <a
    ...
    <ul>
        <li>M. Lux, S.A. Chatzichristofis (2008) LIRE: Lucene Image Retrieval: An extensible Java CBIR Library. ACM
            Multimedia 2008. <a href="http://dl.acm.org/authorize?026312">Download the paper.</a>
        </li>
        ...
        <li>Lux, Mathias, and Glenn Macstravic. "The LIRE Request Handler: A Solr Plug-In for Large Scale Content Based
            Image Retrieval." MultiMedia Modeling. Springer International Publishing, 2014. <a
                href="http://link.springer.com/chapter/10.1007/978-3-319-04117-9_39">Download the paper.</a>
        </li>
        <li> Website: <a href="http://www.lire-project.net/">The LIRE Project</a>
        </li>
    </ul>
</div>
<div class="col-md-4">
    <p class="text-center">
        <img src="images/screenshot-liredemo.jpg" class="img-thumbnail img-responsive"
             style="margin: 2px; max-height: 400px; width: auto">
    </p>
</div>
